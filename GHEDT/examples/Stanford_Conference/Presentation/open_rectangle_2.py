...
def main():
    ...
    key = configuration + '_' + r.create_key(N, M) + '_' + 't' + '_' + str(t)
    ...
    print('total drilling: {}'.format(single_u_tube.b.H * len(GFunction.bore_locations)))
    print('nbh: {}'.format(len(GFunction.bore_locations)))
    ...
    fig.savefig('Open_rectangle_case_{}x{}.png'.format(N, M))
    ...
    fig.savefig('open_rectangle_2_gfunctions.png')
