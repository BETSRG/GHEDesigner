...
class TestGHE(GHEBaseTest):
    ...
    def test_single_u_tube(self):
        ...
        max_hp_eft, min_hp_eft = ghe.simulate(method=TimestepType.HOURLY_FFT)

        self.assertAlmostEqual(28.92, max_hp_eft, delta=0.1)
    ...
    def test_double_u_tube(self):
        ...
        self.assertAlmostEqual(27.90, max_hp_eft, delta=0.1)
    ...
    def test_coaxial_tube(self):
        ...
        self.assertAlmostEqual(27.84, max_hp_eft, delta=0.1)
        self.assertAlmostEqual(17.13, min_hp_eft, delta=0.1)
