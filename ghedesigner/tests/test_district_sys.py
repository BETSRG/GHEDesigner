...
class TestDistrictSys(GHEBaseTest):
    def test_simulate_1_pipe_3_ghe_6_bldg_district(self):
        ...
        System.create_output(self.tests_directory / self.test_data_directory / "simulate_1_pipe_3_ghe_6_bldg_district.csv")
    ...
    def test_simulate_1_pipe_1_ghe_1_bldg_district(self):
        ...
        System.create_output(self.tests_directory / self.test_data_directory / "simulate_1_pipe_1_ghe_1_bldg_district.csv")
