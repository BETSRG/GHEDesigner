...
class TestLoadAggregation(GHEBaseTest):
    ...
    def test_single_u_tube(self):
        ...
        max_hp_eft, min_hp_eft = ghe.simulate(method=TimestepType.HOURLY, load_aggregation=True)

        self.assertAlmostEqual(38.50, max_hp_eft, delta=0.01)
        self.assertAlmostEqual(16.62, min_hp_eft, delta=0.01)

        ghe.size(method=TimestepType.HOURLY, load_aggregation=True)

        self.assertEqual(ghe.nbh, 156)
        self.assertAlmostEqual(ghe.bhe.b.H, 127.02, delta=0.01)
    ...
    def test_double_u_tube(self):
        ...
        self.assertAlmostEqual(37.55, max_hp_eft, delta=0.01)
        self.assertAlmostEqual(16.86, min_hp_eft, delta=0.01)

        ghe.size(method=TimestepType.HOURLY, load_aggregation=True)

        self.assertEqual(ghe.nbh, 156)
        self.assertAlmostEqual(ghe.bhe.b.H, 120.21, delta=0.01)
    ...
    def test_coaxial_tube(self):
        ...
        self.assertAlmostEqual(36.80, max_hp_eft, delta=0.01)
        self.assertAlmostEqual(17.28, min_hp_eft, delta=0.01)

        ghe.size(method=TimestepType.HOURLY, load_aggregation=True)

        self.assertEqual(ghe.nbh, 156)
        self.assertAlmostEqual(ghe.bhe.b.H, 114.71, delta=0.01)
