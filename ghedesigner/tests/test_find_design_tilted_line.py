...
class TestFindTiltedLineDesign(GHEBaseTest):
    ...
    def test_single_u_tube(self):
        ...
        self.assertAlmostEqual(133.33, u_tube_height, delta=0.1)
    ...
    def test_double_u_tube(self):
        ...
        search = self.get_design(pipe, 0.5)
        u_tube_height = search.ghe.bhe.b.H
        self.assertAlmostEqual(133.99, u_tube_height, delta=0.1)
        borehole_location_data_rows = search.ghe.gFunction.bore_locations
        self.assertEqual(62, len(borehole_location_data_rows))
    ...
    def test_coaxial(self):
        ...
        u_tube_height = search.ghe.bhe.b.H
        self.assertAlmostEqual(134.52, u_tube_height, delta=0.1)
        borehole_location_data_rows = search.ghe.gFunction.bore_locations
