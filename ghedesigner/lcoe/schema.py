...
_UNIT_RATE_CAPEX = {
    ...
    "additionalProperties": False,
    "properties": {
        "drilling_per_meter": {"type": "number", "minimum": 0.0},
        "vertical_pipe_per_meter": {"type": "number", "minimum": 0.0},
        # User must supply horizontal_pipe_length_m (GHEDesigner does not compute it)
        "horizontal_pipe_length_m": {"type": "number", "minimum": 0.0},
        "horizontal_pipe_per_meter": {"type": "number", "minimum": 0.0},
        "grout_per_m3": {"type": "number", "minimum": 0.0},
        "heat_pump_per_unit": {"type": "number", "minimum": 0.0},
    },
}
