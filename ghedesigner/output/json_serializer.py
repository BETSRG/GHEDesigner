    ...
    def summary_object(
        ...
        obj: dict[str, Any] = {
            ...
            "ghe_system": {
                ...
                "pipe_volumetric_heat_capacity": unit(ghe.bhe.pipe.rhoCp / 1000, "kJ/m3-K"),
                "grout_thermal_conductivity": unit(ghe.bhe.grout.k, "W/m-K"),
                "grout_volumetric_heat_capacity": unit(ghe.bhe.grout.rhoCp / 1000, "kJ/m3-K"),
                ...
                "soil_volumetric_heat_capacity": unit(ghe.bhe.soil.rhoCp / 1000, "kJ/m3-K"),
                "soil_undisturbed_ground_temp": unit(ghe.bhe.soil.ugt, "C"),
                "fluid_volumetric_heat_capacity": unit(ghe.bhe.fluid.rhoCp / 1000, "kJ/m3-K"),
                "fluid_thermal_conductivity": unit(ghe.bhe.fluid.k, "W/m-K"),
                "fluid_viscosity": unit(ghe.bhe.fluid.dynamic_viscosity(), "Pa-s"),
