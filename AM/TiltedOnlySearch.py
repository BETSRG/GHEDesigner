...
start = perf_counter()
def tsearch(input_json: Path, output_base: Path, multipliers: list[float]):
    ...
    csv_path = output_base / "tilted_results.csv"
...
def main():
    ...
    output_dir = Path(r"C:\\Users\\Student\\Desktop\\TiltedOnlySearch")

    multipliers = [0.1, 0.5, 1.0, 3.0]

    print("Beginning search...")
    tsearch(input_file, output_dir, multipliers)
    end = perf_counter()
