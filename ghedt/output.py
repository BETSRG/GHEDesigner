...
def OutputDesignDetails(design,time,projectName,notes,author,modelName,allocatedWidth = 100,roundingAmount=10,
    ...
    oS += "Fluid Properties" + "\n"
    oS += createDRow(allocatedWidth, "Volumetric Heat Capacity, kJ/(K*m^3):", round(bhe.fluid.rhoCp/1000,roundingAmount), stringFormat, floatFormat,bTabs=indentedAmount)
    oS += createDRow(allocatedWidth, "Thermal Conductivity, W/(m*K):", round(bhe.fluid.k,roundingAmount), stringFormat, floatFormat,bTabs=indentedAmount)
