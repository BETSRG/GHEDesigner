...
def main():
    ...
    ax.plot(list(range(1, n_years+1)), Excess_temperatures['Hourly'], marker='o',
            ls='--', label='Hourly')
    ax.plot(list(range(1, n_years+1)), Excess_temperatures['Hybrid'], marker='s',
            ls='--', label='Hybrid')
    ...
    fig.savefig('excess_temperatures_hybrid.png')
    ...
    ax.plot(list(range(1, n_years + 1)), Minimum_temperatures['Hourly'],
            marker='o',
            ls='--', label='Hourly (min)')
    ax.plot(list(range(1, n_years + 1)), Maximum_temperatures['Hourly'],
            marker='o',
            ls='--', label='Hourly (max)')
    ax.plot(list(range(1, n_years + 1)), Minimum_temperatures['Hybrid'],
            marker='s',
            ls='--', label='Hybrid (min)')
    ax.plot(list(range(1, n_years + 1)), Maximum_temperatures['Hybrid'],
            marker='s',
            ls='--', label='Hybrid (max)')
    ...
    fig.savefig('min_and_max_hybrid.png')
    ...
    ax.plot(list(range(1, n_years+1)), Simulation_times['Hourly'], marker='o',
            ls='--', label='Hourly')
    ax.plot(list(range(1, n_years+1)), Simulation_times['Hybrid'], marker='s',
            ls='--', label='Hybrid')
    ...
    fig.savefig('simulation_clock_time_hybrid.png')
