...
def main():
    ...
    for k in range(len(height_values)):
        ...
        for i in range(len(predicted_folders)):
            ...
            _label = predicted_folder_i.replace('_', ' ').replace('MIFT', 'UIFT')
            _label = _label.replace('12 Equal Segments', '12ESL').\
                replace('8 Unequal Segments', '8USL')
        ...
        fig.legend(bbox_to_anchor=(0.44, 1.01))
