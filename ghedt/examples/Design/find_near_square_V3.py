...
def main():
    ...
    while cB < BetaStop:
        ...
        cB += BetaStep
    outputArray = []
    outputArray.append(["AvgH","1/Beta","Beta","fieldSpecifier","h1","h2","Total Drilling"])
    for BetaVal in BetaVals:
        ...
        coords,indices,boreholes = ground_heat_exchangers.multiDepthSquare(avgH,Betas,15,15,D,r_b,spacing=B)
        ...
        outputArray.append([ghe.averageHeight(), 1.0/BetaVal, BetaVal,h1,h2, totalDrilling])
