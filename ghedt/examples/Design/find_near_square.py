...
def main():
    ...
    for BetaVal in BetaVals:
        ...
        ghe = ground_heat_exchangers.GHE([V_flow,V_flow],B,single_u_tube,fluid,boreholes,indices,pipe_single,grout,soil,gfunction_obj,sim_params,hourly_extraction_ground_loads)
        ...
        outputArray.append([ghe.averageHeight(), 1.0/BetaVal, BetaVal, m, n, nBSum, nSum, n1 , n2 ,h1,h2, totalDrilling])
